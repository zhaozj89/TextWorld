...
The kitchen part 5 is some text that varies. The kitchen part 5 is " You make out a table. You wonder idly who left that here. [if there is something on the s_0]On the table you can make out [a list of things on the s_0].[end if]".
...
The kitchen part 9 is some text that varies. The kitchen part 9 is " If you haven't noticed it already, there seems to be something there by the wall, it's a stove. The stove is conventional.[if there is something on the stove_0] On the stove you see [a list of things on the stove_0]. You can't wait to tell the folks at home about this![end if]".
...
The kitchen part 13 is some text that varies. The kitchen part 13 is " plain door leading north. You need an exit without a door? You should try going south. You need an exit without a door? You should try going west.".
...
The internal name of r_2 is "garden".
The printed name of r_2 is "-= Garden =-".
The garden part 0 is some text that varies. The garden part 0 is "You are in an usual kind of place. That is to say, you're in a garden.



 There is [if d_2 is open]an open[otherwise]a closed[end if]".
The garden part 1 is some text that varies. The garden part 1 is " sliding patio door leading west. You don't like doors? Why not try going north, that entranceway is not blocked by one.".
The description of r_2 is "[garden part 0][garden part 1]".
...
The livingroom part 2 is some text that varies. The livingroom part 2 is "
 ...
 There is [if d_2 is open]an open[otherwise]a closed[end if]".
The livingroom part 3 is some text that varies. The livingroom part 3 is " sliding patio door leading east. You need an exit without a door? You should try going north.".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You arrive in a backyard. A standard one.
 ...
 You can see a patio table. The patio table is stylish.[if there is something on the s_4] On the patio table you can see [a list of things on the s_4].[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You bend down to tie your shoe. When you stand up, you notice a patio chair. [if there is something on the s_6]You see [a list of things on the s_6] on the patio chair.[end if]".
...
The backyard part 6 is some text that varies. The backyard part 6 is "
 ...
 There is [if d_1 is open]an open[otherwise]a closed[end if]".
The backyard part 7 is some text that varies. The backyard part 7 is " screen door leading west. You don't like doors? Why not try going south, that entranceway is not blocked by one.".
The description of r_3 is "[backyard part 0][backyard part 1][backyard part 2][backyard part 3][backyard part 4][backyard part 5][backyard part 6][backyard part 7]".
...
The pantry part 0 is some text that varies. The pantry part 0 is "You arrive in a pantry. A typical kind of place.
 ...
 You see a shelf. [if there is something on the s_2]You see [a list of things on the s_2] on the shelf. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
