...
class Game:
    ...
    def __init__(self,
        ...
        self.infos = {v.name: EntityInfo(v.name, v.type) for fact in state.facts for v in fact.arguments}
        self.metadata = {}
    ...
    def command_templates(self) -> List[str]:
        ...
        return sorted(set(action.template for action in self.state._logic.actions.values()))
    ...
    def objects_types(self) -> List[str]:
        ...
        return sorted(self.state._logic.types)
...
class GameProgression:
    ...
    def __init__(self, game: Game, track_quests: bool = True) -> None:
        ...
        """
        self.game = game
        self.state = game.state#.copy() TODO
        self._valid_actions = list(self.state.all_applicable_actions())
    ...
    def update(self, action: Action) -> None:
        ...
        """
        # Update world facts.
        effects = self.state.apply(action)
